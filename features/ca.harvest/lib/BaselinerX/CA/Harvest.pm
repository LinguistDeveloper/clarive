...
register 'config.ca.harvest.map' => {
    ...
    metadata => [
        ...
        { id=>'baseline_to_view', label=>'From Baseline to View', type=>'hash' },
        { id=>'states_for_job', label=>'Map Job Types and their From State', type=>'hash' },
        { id=>'states_for_checkin', label=>'States in which CheckIn operations are allowed (comma separated)', type=>'hash' },
    ]
};
...
register 'config.ca.harvest.cli' => {
    ...
    metadata => [
        { id=>'broker', type=>'text' },
        { id=>'login', type=>'text' },
        { id=>'permissions', label=>'Checkout File Permissions', type=>'text', default=>'755' },
        { id=>'checkin_process', label=>'Default checkin process name', type=>'text', default=>'' },
        { id=>'checkout_process', label=>'Default checkout process name', type=>'text', default=>'' },
        { id=>'package_create_process', label=>'Default create package process name', type=>'text', default=>'' },
        { id=>'package_create_state', label=>'Default create package state name', type=>'text', default=>'' },
        { id=>'package_delete_process', label=>'Default delete package process name', type=>'text', default=>'' },
    ]
};
