package Baseliner::Schema::Inf::Result::InfReportMeta;
...
__PACKAGE__->table("inf_report_meta");
...
__PACKAGE__->add_unique_constraint("uk_inf_report_meta", ["column_name"]);


# Created by DBIx::Class::Schema::Loader v0.04006 @ 2011-03-21 13:18:19
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QIB99j0PUfop8Xx0x15BrQ
