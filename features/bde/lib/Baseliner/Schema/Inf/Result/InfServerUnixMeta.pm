package Baseliner::Schema::Inf::Result::InfServerUnixMeta;
...
__PACKAGE__->table("inf_server_unix_meta");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:p4wUH3+usKLrXYWRrcLvvA
