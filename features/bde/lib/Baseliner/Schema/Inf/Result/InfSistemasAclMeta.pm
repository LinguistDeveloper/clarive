package Baseliner::Schema::Inf::Result::InfSistemasAclMeta;
...
__PACKAGE__->table("inf_sistemas_acl_meta");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ScpGK0tsx9/M9mlJXp0J4g
