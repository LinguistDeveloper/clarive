package Baseliner::Schema::Inf::Result::InfServerWasMeta;
...
__PACKAGE__->table("inf_server_was_meta");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7yBdxQ8kIB2jApH0kLtjSQ
