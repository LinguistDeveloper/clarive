package Baseliner::Schema::Inf::Result::InfParadataSection;
...
__PACKAGE__->table("inf_paradata_section");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Z040zilGYUbhl0TjgyVDzA
