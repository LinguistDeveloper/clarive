package Baseliner::Schema::Harvest::Result::BdePaqueteVignette;
...
__PACKAGE__->table("bde_paquete_vignette");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bMuPy2C5ZgzW+jFCK9brNw
