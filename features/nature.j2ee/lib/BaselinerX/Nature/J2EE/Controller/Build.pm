...
register 'action.nature.j2ee.config.build' => { name=>'Config J2EE Build' };
register 'menu.nature.j2ee' => { label => 'J2EE', actions=>['action.nature.j2ee.config.build', 'action.nature.j2ee.config.deploy'] };
register 'menu.nature.j2ee.build' => { label => 'Build', url_comp => '/j2ee/build', title=>'Build', actions=>['action.nature.j2ee.config.build'] };
