(function (params) {
  ...
  var load_paths = function () {
      ...
      store_from.baseParams = {
        prefix: '/' + project,
        os: 'unix'
      };
      store_user.baseParams = {
        project: project,
        ns: ns,
        bl: bl
      };
      store_user.load();
      store_group.baseParams = {
        project: project,
        ns: ns,
        bl: bl
      };
      store_group.load();
      store_host.baseParams = {
        project: project,
        ns: ns,
        bl: bl
      };
  ...
  var combo_bl = Baseliner.combo_baseline({
    value: params.bl,
    hiddenName: 'bl',
    on_select: load_paths
  });
  var form = new Ext.FormPanel({
    ...
    combo_host, combo_user, combo_group,
    {
      xtype: 'textarea',
      height: 150,
      name: 'description',
      fieldLabel: _('Mapping Description'),
