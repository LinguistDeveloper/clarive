...
register 'fieldlet.combo' => {
    ...
    icon        => '/static/images/icons/combo-box.svg',
    section_default => 'body',
...
register 'fieldlet.dbi_query' => {
    ...
    icon        => '/static/images/icons/sql-blue.svg',
    type        => 'combo',
    show_in_palette => 0,
    section_default => 'head',
...
register 'fieldlet.status_chart_pie' => {
    ...
    icon        => '/static/images/icons/chart-pie.svg',
    type        => 'generic',
    section     => 'details',
    section_allowed => ['details']
};
...
register 'fieldlet.checkbox' => {
    ...
    icon        => '/static/images/icons/admin-request.svg',
    type        => 'checkbox',
