...
register 'fieldlet.include_into' => {
    ...
    icon        => '/static/images/icons/fieldlet-include-into.svg',
    origin      => 'default',
    editable    => 0,
...
register 'fieldlet.attach_file' => {
    ...
    icon            => '/static/images/icons/fieldlet-attach-file.svg',
...
register 'fieldlet.progressbar' => {
    ...
    icon        => '/static/images/icons/fieldlet-progressbar.svg',
    meta_type   => 'number',
    section => 'between',
...
register 'fieldlet.calculated_number' => {
    ...
    icon        => '/static/images/icons/fieldlet-calculated-number.svg',
    meta_type   => 'number',
...
register 'fieldlet.datetime' => {
    ...
    icon        => '/static/images/icons/fieldlet-datetime.svg',
    meta_type   => 'date',
    type        => 'datefield',
    section     => 'body',
    section_allowed => ['body'],
...
register 'fieldlet.time' => {
    ...
    icon        => '/static/images/icons/fieldlet-time.svg',
    type        => 'timefield',
    section_default => 'body',
    section_allowed => ['body']
};
...
register 'fieldlet.ci_list' => {
    ...
    icon        => '/static/images/icons/fieldlet-ci-list.svg',
    section_default => 'head',
...
register 'fieldlet.ci_grid' => {
    ...
    icon        => '/static/images/icons/fieldlet-ci-grid.svg',
    section_default => 'head',
    section_allowed => ['head','more']
};
...
register 'fieldlet.combo' => {
    ...
    icon        => '/static/images/icons/fieldlet-combo.svg',
    section_default => 'body',
...
register 'fieldlet.dbi_query' => {
    ...
    icon        => '/static/images/icons/fieldlet-dbi-query.svg',
    type        => 'combo',
    show_in_palette => 0,
    section_default => 'head',
...
register 'fieldlet.download_all_files' => {
    ...
    icon        => '/static/images/icons/fieldlet-download-all.svg',
    type        => 'upload_files',
    relation    => 'system',
    categories  => 'all',
    files_field => 'all',
...
register 'fieldlet.grid_editor' => {
    ...
    icon        => '/static/images/icons/fieldlet-grid-editor.svg',
    type        => 'generic',
    section_default => 'head',
    section_allowed => ['head','more']
};
...
register 'fieldlet.milestones' => {
    ...
    icon        => '/static/images/icons/fieldlet-milestones.svg',
    relation    => 'system',
    get_method  => 'get_cal',
    set_method  => 'set_cal',
    type        => 'generic',
...
register 'fieldlet.env_planner' => {
    ...
    icon        => '/static/images/icons/fieldlet-env-planner.svg',
    relation    => 'system',
    get_method  => 'get_cal',
    set_method  => 'set_cal',
    type        => 'generic',
...
register 'fieldlet.scheduler' => {
    ...
    icon        => '/static/images/icons/fieldlet-scheduler.svg',
    relation    => 'system',
    get_method  => 'get_cal',
    set_method  => 'set_cal',
    type        => 'generic',
...
register 'fieldlet.html_editor' => {
    ...
    icon        => '/static/images/icons/fieldlet-html-editor.svg',
    type        => 'html/editor',
    meta_type   => 'content',
    section_default => 'head',
    section_allowed => ['head','more']
...
register 'fieldlet.pagedown' => {
    ...
    icon        => '/static/images/icons/fieldlet-pagedown.svg',
    type        => 'generic',
    meta_type   => 'content',
    section_default => 'head',
    section_allowed => ['head','more']
...
register 'fieldlet.pills' => {
    ...
    icon        => '/static/images/icons/fieldlet-pills.svg',
    section_default => 'body',
    section_allowed => ['body']
};
...
register 'fieldlet.status_chart_pie' => {
    ...
    icon        => '/static/images/icons/fieldlet-status-chart-pie.svg',
    type        => 'generic',
    section     => 'details',
    section_allowed => ['details']
};
...
register 'fieldlet.status_changes' => {
    ...
    icon        => '/static/images/icons/fieldlet-status-changes.svg',
    type        => 'datefield',
    meta_type   => 'history',
    relation    => 'system',
    section_default => 'details',
...
register 'fieldlet.topic_grid' => {
    ...
    icon            => '/static/images/icons/fieldlet-topic-grid.svg',
...
register 'fieldlet.checkbox' => {
    ...
    icon        => '/static/images/icons/fieldlet-checkbox.svg',
    type        => 'checkbox',
...
register 'fieldlet.separator' => {
    ...
    icon        => '/static/images/icons/fieldlet-separator.svg',
    holds_children => 1,
    isTarget => 1
};
...
register 'fieldlet.text' => {
    ...
    icon        => '/static/images/icons/fieldlet-text.svg',
    type        => 'textfield',
    section_default => 'head',
...
register 'fieldlet.text_plain' => {
    ...
    icon        => '/static/images/icons/fieldlet-text-plain.svg',
    type        => 'textarea',
    section_default => 'head',
    section_allowed => ['head','more']
};
...
register 'fieldlet.number' => {
    ...
    icon        => '/static/images/icons/fieldlet-number.svg',
    meta_type   => 'number',
    section_default => 'body',
    section_allowed => ['body'],
    limit_height   => 1
...
register 'fieldlet.system.status_new' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-status.svg',
...
register 'fieldlet.system.moniker' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-moniker.svg',
    html        => '/fields/templates/html/row_body.html',
    origin      => 'system',
    type        => 'textfield',
    bd_field    => 'moniker',
...
register 'fieldlet.system.title' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-title.svg',
    type        => 'textfield',
    origin      => 'system',
    section     => 'title',
...
register 'fieldlet.system.description' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-description.svg',
...
register 'fieldlet.system.revisions' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-revisions.svg',
...
register 'fieldlet.system.release' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-release.svg',
...
register 'fieldlet.system.release_version' => {
    ...
    js          => '/fields/templates/js/textfield.js',
    form        => '/fields/templates/config/textfield.js',
    icon        => '/static/images/icons/fieldlet-system-release-version.svg',
    type        => 'textfield',
    section_default => 'head',
    section_allowed => ['head','more','body'],
    limit_height   => 1
...
register 'fieldlet.system.projects' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-projects.svg',
...
register 'fieldlet.system.users' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-users.svg',
...
register 'fieldlet.system.topics' => {
    name        => _locl('Topics'),
    icon        => '/static/images/icons/fieldlet-system-topics.svg',
    get_method  => 'get_topics',
    set_method  => 'set_topics',
...
register 'fieldlet.system.list_topics' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-list-topics.svg',
    get_method  => 'get_topics',
    set_method  => 'set_topics',
    section_allowed => ['head','more'],
    ...
    rel_type    => 'topic_topic',
    section_default => 'head',
    section_allowed => ['head','more','details','body'],
    limit_height   => 1
};
...
register 'fieldlet.system.cis' => {
    name        => _locl('CI Combo'),
    icon        => '/static/images/icons/fieldlet-system-cis.svg',
    get_method  => 'get_cis',
    set_method  => 'set_cis',
...
register 'fieldlet.system.tasks' => {
    ...
    icon        => '/static/images/icons/fieldlet-system-tasks.svg',
    get_method  => '',
    set_method  => '',
    html        => '',
    js          => '',
...
register 'fieldlet.required.category' => {
    ...
    icon        => '/static/images/icons/fieldlet-required-category.svg',
    origin      => 'system',
    relation    => 'categories',
    hidden      => '1',
    system_force => 'true',
