...
register 'dashlet.job.last_jobs' => {
    ...
    icon=> '/static/images/icons/dashlet-job-last.svg',
...
register 'dashlet.job.list_jobs' => {
    ...
    icon=> '/static/images/icons/dashlet-job-list.svg',
...
register 'dashlet.job.list_baseline' => {
    ...
    icon=> '/static/images/icons/dashlet-job-bl.svg',
...
register 'dashlet.job.chart' => {
    ...
    icon=> '/static/images/icons/dashlet-job-chart.svg',
...
register 'dashlet.job.day_distribution' => {
    ...
    icon=> '/static/images/icons/dashlet-job-day.svg',
...
register 'dashlet.ci.graph' => {
    ...
    name=> _locl('CI Graph'),
    icon=> '/static/images/icons/dashlet-ci-graph.svg',
...
register 'dashlet.topic.number_of_topics' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-chart.svg',
...
register 'dashlet.topic.list_topics' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-list.svg',
...
register 'dashlet.topic.topics_by_date_line' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-dateline.svg',
...
register 'dashlet.topic.topics_burndown' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-burndown.svg',
...
register 'dashlet.topic.topics_period_burndown' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-period.svg',
...
register 'dashlet.topic.topics_burndown_ng' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-ng.svg',
...
register 'dashlet.topic.gauge' => {
    ...
    field_width => '80%',
    icon=> '/static/images/icons/dashlet-topic-gauge.svg',
...
register 'dashlet.topic.topic_roadmap' => {
    ...
    icon=> '/static/images/icons/dashlet-topic-roadmap.svg',
...
register 'dashlet.topic.calendar' => {
    ...
    name=> _locl('Calendar'),
    icon=> '/static/images/icons/dashlet-topic-calendar.svg',
...
register 'dashlet.iframe' => {
    ...
    icon=> '/static/images/icons/dashlet-iframe.svg',
...
register 'dashlet.email' => {
    ...
    icon=> '/static/images/icons/dashlet-email.svg',
...
register 'dashlet.html' => {
    ...
    name=> 'HTML',
    icon=> '/static/images/icons/dashlet-html.svg',
