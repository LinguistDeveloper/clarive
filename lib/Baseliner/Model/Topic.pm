...
sub get_system_fields {
    ...
    my @system_fields = (
            ...
            { id_field => 'created_by', params => {name_field => 'Created By', bd_field => 'created_by', origin => 'default', html => '/fields/templates/html/row_head.html', field_order => 0, section => 'head', field_order_html => 2 }},
