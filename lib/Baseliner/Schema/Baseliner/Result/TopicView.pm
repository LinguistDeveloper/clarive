...
__PACKAGE__->result_source_instance->view_definition(q{
    ...
    SELECT  T.MID TOPIC_MID, TITLE, T.CREATED_ON, T.CREATED_BY, STATUS,  NUMCOMMENT, C.ID CATEGORY_ID, C.NAME CATEGORY_NAME, PROGRESS,
            ...
            RESPONSE_TIME_MIN, EXPR_RESPONSE_TIME, DEADLINE_MIN, EXPR_DEADLINE, C.COLOR CATEGORY_COLOR, C.IS_CHANGESET, C.IS_RELEASE,
            L.ID LABEL_ID, L.NAME LABEL_NAME, L.COLOR LABEL_COLOR,
