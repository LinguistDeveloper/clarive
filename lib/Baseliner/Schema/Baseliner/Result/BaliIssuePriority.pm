use utf8;
package Baseliner::Schema::Baseliner::Result::BaliIssuePriority;
...
Baseliner::Schema::Baseliner::Result::BaliIssuePriority
...
=head1 TABLE: C<bali_issue_priority>

=cut

__PACKAGE__->table("bali_issue_priority");
...
=head2 id
  ...
  sequence: 'bali_issue_priority_seq'
  size: 126
