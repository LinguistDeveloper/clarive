...
sub jobList : Path('/job/log/jobList') {
    ...
    _debug $p;
    my $pkgIcon   = '/static/images/icons/jes-spool-package.svg';
    my $siteIcon  = '/static/images/icons/jes-spool-site.svg';
    my $jobIcon   = '/static/images/icons/jes-spool-job.svg';
    my $spoolIcon = '/static/images/icons/jes-spool-item.svg';
