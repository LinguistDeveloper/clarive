...
--
DROP TABLE "bali_chained_rule" CASCADE;
CREATE TABLE "bali_chained_rule" (
  ...
  "dsl" character varying(20),
  "dsl_code" clob NOT NULL,
  "active" character(1) DEFAULT NULL NOT NULL,
  PRIMARY KEY ("id")
);
...
CREATE TABLE "bali_relationship" (
  "from_ns" character varying(1024) NOT NULL,
  "to_ns" character varying(1024) NOT NULL,
  "from_id" bigint,
  "to_id" bigint,
...
CREATE TABLE "bali_sem" (
  "sem" character varying(1024) NOT NULL,
  "description" character varying(2147483647),
  "slots" bigint DEFAULT 1,
  "active" bigint DEFAULT 1,
  "bl" character varying(255) DEFAULT '*' NOT NULL,
  "queue_mode" character varying(255) DEFAULT 'slot' NOT NULL,
  PRIMARY KEY ("sem", "bl")
);
...
CREATE TABLE "bali_sem_queue" (
  ...
  "seq" bigint,
  "id_job" bigint,
  "run_now" bigint DEFAULT 0,
  "wait_secs" bigint DEFAULT 0,
  "busy_secs" bigint DEFAULT 0,
...
--
DROP TABLE "bali_user_project" CASCADE;
...
-- Table: bali_repokeys
--
DROP TABLE "bali_repokeys" CASCADE;
...
ALTER TABLE "bali_repokeys" ADD FOREIGN KEY ("ns")
  REFERENCES "bali_repo" ("ns") ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE;
