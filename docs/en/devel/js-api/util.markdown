...
Dumps the `data` argument as [JSON <img class='ext-link' src='static/images/icons/window-new.svg' />](https://en.wikipedia.org/wiki/JSON).
...
Loads `data` from a [JSON <img class='ext-link' src='static/images/icons/window-new.svg' />](https://en.wikipedia.org/wiki/JSON) string.
