...
-- Created on Fri May 18 13:29:23 2012
-- 
--
-- Table: bali_baseline
--;
...
CREATE SEQUENCE sq_bali_topic_id;
...
--
-- Table: bali_topic_categories
--;

CREATE SEQUENCE sq_bali_topic_categories_id;
...
--
-- Table: bali_topic_msg
--;

CREATE SEQUENCE sq_bali_topic_msg_id;
...
--
-- Table: bali_topic_priority
--;

CREATE SEQUENCE sq_bali_topic_priority_id;
...
--
-- Table: bali_topic_status
--;

CREATE SEQUENCE sq_bali_topic_status_id;
...
--
-- Table: bali_topic_categories_status
--;
...
ALTER TABLE bali_topic_categories_status ADD CONSTRAINT bali_topic_categories_status_i FOREIGN KEY (id_status) REFERENCES bali_topic_status (id);

ALTER TABLE bali_topic_label ADD CONSTRAINT bali_topic_label_id_label_fk FOREIGN KEY (id_label) REFERENCES bali_label (id);

ALTER TABLE bali_topic_project ADD CONSTRAINT bali_topic_project_id_project_ FOREIGN KEY (id_project) REFERENCES bali_project (id);
...
CREATE INDEX bali_topic_label_idx_id_label on bali_topic_label (id_label);

CREATE INDEX bali_topic_project_idx_id_proj on bali_topic_project (id_project);
...
CREATE OR REPLACE TRIGGER ai_bali_topic_id
BEFORE INSERT ON bali_topic
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_topic_id.nextval
 INTO :new.id
 FROM dual;
END;
/

CREATE OR REPLACE TRIGGER ai_bali_topic_categories_id
BEFORE INSERT ON bali_topic_categories
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_topic_categories_id.nextval
 INTO :new.id
 FROM dual;
END;
/

CREATE OR REPLACE TRIGGER ai_bali_topic_msg_id
BEFORE INSERT ON bali_topic_msg
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_topic_msg_id.nextval
 INTO :new.id
 FROM dual;
END;
/

CREATE OR REPLACE TRIGGER ai_bali_topic_priority_id
BEFORE INSERT ON bali_topic_priority
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_topic_priority_id.nextval
 INTO :new.id
 FROM dual;
END;
/

CREATE OR REPLACE TRIGGER ai_bali_topic_status_id
BEFORE INSERT ON bali_topic_status
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_topic_status_id.nextval
 INTO :new.id
 FROM dual;
END;
/
