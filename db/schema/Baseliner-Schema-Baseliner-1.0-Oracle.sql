...
-- Created on Wed Aug 17 20:27:54 2011
-- 
--
-- Table: bali_baseline
--;
...
CREATE TABLE bali_chained_rule (
  ...
  active char(1) DEFAULT NULL NOT NULL,
  PRIMARY KEY (id)
);
...
DROP SEQUENCE sq_bali_user_project_id;

CREATE SEQUENCE sq_bali_user_project_id;
...
CREATE OR REPLACE TRIGGER ai_bali_user_project_id
BEFORE INSERT ON bali_user_project
FOR EACH ROW WHEN (
 new.id IS NULL OR new.id = 0
)
BEGIN
 SELECT sq_bali_user_project_id.nextval
 INTO :new.id
 FROM dual;
END;
/
...
/
    ...
    CREATE OR REPLACE TRIGGER BALI_LOG_TRG
        BEFORE INSERT ON BALI_LOG
    ...
    CREATE SEQUENCE BALI_CHAINED_SERVICE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CHAINED_SERVICE_TRG
    ...
    DROP SEQUENCE BALI_MESSAGE_QUEUE_SEQ;

    CREATE SEQUENCE BALI_MESSAGE_QUEUE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_MESSAGE_QUEUE_TRG
        BEFORE INSERT ON BALI_MESSAGE_QUEUE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_MESSAGE_QUEUE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_LOG_DATA_SEQ;

    CREATE SEQUENCE BALI_LOG_DATA_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_LOG_DATA_TRG
        BEFORE INSERT ON BALI_LOG_DATA
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_LOG_DATA_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_RELATIONSHIP_SEQ;

    CREATE SEQUENCE BALI_RELATIONSHIP_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_RELATIONSHIP_TRG
        BEFORE INSERT ON BALI_RELATIONSHIP
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_RELATIONSHIP_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_SEM_SEQ;

    CREATE SEQUENCE BALI_SEM_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_SEM_TRG
        BEFORE INSERT ON BALI_SEM
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_SEM_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_JOB_ITEMS_SEQ;

    CREATE SEQUENCE BALI_JOB_ITEMS_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_JOB_ITEMS_TRG
        BEFORE INSERT ON BALI_JOB_ITEMS
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_JOB_ITEMS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_REPOKEYS_SEQ;

    CREATE SEQUENCE BALI_REPOKEYS_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_REPOKEYS_TRG
        BEFORE INSERT ON BALI_REPOKEYS
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_REPOKEYS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_USER_SEQ;

    CREATE SEQUENCE BALI_USER_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_USER_TRG
        BEFORE INSERT ON BALI_USER
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_USER_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_ROLEUSER_SEQ;

    CREATE SEQUENCE BALI_ROLEUSER_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_ROLEUSER_TRG
        BEFORE INSERT ON BALI_ROLEUSER
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_ROLEUSER_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;
    ...
    CREATE OR REPLACE TRIGGER BALI_JOB_TRG
        BEFORE INSERT ON BALI_JOB
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
    ...
    DROP SEQUENCE BALI_MESSAGE_SEQ;

    CREATE SEQUENCE BALI_MESSAGE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_MESSAGE_TRG
        BEFORE INSERT ON BALI_MESSAGE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_MESSAGE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_REQUEST_SEQ;

    CREATE SEQUENCE BALI_REQUEST_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_REQUEST_TRG
        BEFORE INSERT ON BALI_REQUEST
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_REQUEST_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_NAMESPACE_SEQ;

    CREATE SEQUENCE BALI_NAMESPACE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_NAMESPACE_TRG
        BEFORE INSERT ON BALI_NAMESPACE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_NAMESPACE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_ROLE_SEQ;

    CREATE SEQUENCE BALI_ROLE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_ROLE_TRG
        BEFORE INSERT ON BALI_ROLE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_ROLE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;
    ...
    CREATE SEQUENCE BALI_CHAIN_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CHAIN_TRG
    ...
    DROP SEQUENCE BALI_PLUGIN_SEQ;

    CREATE SEQUENCE BALI_PLUGIN_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_PLUGIN_TRG
        BEFORE INSERT ON BALI_PLUGIN
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_PLUGIN_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_DAEMON_SEQ;

    CREATE SEQUENCE BALI_DAEMON_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_DAEMON_TRG
        BEFORE INSERT ON BALI_DAEMON
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_DAEMON_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_PROJECT_ITEMS_SEQ;

    CREATE SEQUENCE BALI_PROJECT_ITEMS_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_PROJECT_ITEMS_TRG
        BEFORE INSERT ON BALI_PROJECT_ITEMS
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_PROJECT_ITEMS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_SESSION_SEQ;

    CREATE SEQUENCE BALI_SESSION_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_SESSION_TRG
        BEFORE INSERT ON BALI_SESSION
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_SESSION_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_PROVIDER_SEQ;

    CREATE SEQUENCE BALI_PROVIDER_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_PROVIDER_TRG
        BEFORE INSERT ON BALI_PROVIDER
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_PROVIDER_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_BASELINE_SEQ;

    CREATE SEQUENCE BALI_BASELINE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_BASELINE_TRG
        BEFORE INSERT ON BALI_BASELINE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_BASELINE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_JOB_STASH_SEQ;

    CREATE SEQUENCE BALI_JOB_STASH_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_JOB_STASH_TRG
        BEFORE INSERT ON BALI_JOB_STASH
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_JOB_STASH_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_CALENDAR_SEQ;

    CREATE SEQUENCE BALI_CALENDAR_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CALENDAR_TRG
        BEFORE INSERT ON BALI_CALENDAR
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_CALENDAR_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_REPO_SEQ;

    CREATE SEQUENCE BALI_REPO_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_REPO_TRG
        BEFORE INSERT ON BALI_REPO
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_REPO_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_USER_PROJECT_SEQ;

    CREATE SEQUENCE BALI_USER_PROJECT_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_USER_PROJECT_TRG
        BEFORE INSERT ON BALI_USER_PROJECT
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_USER_PROJECT_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_CONFIG_REL_SEQ;

    CREATE SEQUENCE BALI_CONFIG_REL_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CONFIG_REL_TRG
        BEFORE INSERT ON BALI_CONFIG_REL
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_CONFIG_REL_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_ROLEACTION_SEQ;

    CREATE SEQUENCE BALI_ROLEACTION_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_ROLEACTION_TRG
        BEFORE INSERT ON BALI_ROLEACTION
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_ROLEACTION_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_WIKI_SEQ;

    CREATE SEQUENCE BALI_WIKI_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_WIKI_TRG
        BEFORE INSERT ON BALI_WIKI
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_WIKI_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;
    ...
    CREATE SEQUENCE BALI_CONFIG_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CONFIG_TRG
    ...
    CREATE SEQUENCE BALI_RELEASE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_RELEASE_TRG
    ...
    DROP SEQUENCE BALI_SEM_QUEUE_SEQ;

    CREATE SEQUENCE BALI_SEM_QUEUE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    DROP SEQUENCE BALI_CHAINED_RULE_SEQ;

    CREATE SEQUENCE BALI_CHAINED_RULE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CHAINED_RULE_TRG
        BEFORE INSERT ON BALI_CHAINED_RULE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_CHAINED_RULE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_RELEASE_ITEMS_SEQ;

    CREATE SEQUENCE BALI_RELEASE_ITEMS_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_RELEASE_ITEMS_TRG
        BEFORE INSERT ON BALI_RELEASE_ITEMS
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_RELEASE_ITEMS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_PROJECT_SEQ;

    CREATE SEQUENCE BALI_PROJECT_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_PROJECT_TRG
        BEFORE INSERT ON BALI_PROJECT
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_PROJECT_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_SERVICE_SEQ;

    CREATE SEQUENCE BALI_SERVICE_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_SERVICE_TRG
        BEFORE INSERT ON BALI_SERVICE
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_SERVICE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_CONFIGSET_SEQ;

    CREATE SEQUENCE BALI_CONFIGSET_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CONFIGSET_TRG
        BEFORE INSERT ON BALI_CONFIGSET
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_CONFIGSET_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;

        

    DROP SEQUENCE BALI_CALENDAR_WINDOW_SEQ;

    CREATE SEQUENCE BALI_CALENDAR_WINDOW_SEQ
      START WITH 1
      MAXVALUE 999999999999999999999999999
      MINVALUE 1
      NOCYCLE
    ...
    CREATE OR REPLACE TRIGGER BALI_CALENDAR_WINDOW_TRG
        BEFORE INSERT ON BALI_CALENDAR_WINDOW
        REFERENCING NEW AS NEW OLD AS OLD
        FOR EACH ROW
        BEGIN
           SELECT BALI_CALENDAR_WINDOW_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
        END;
