        ...
        handler: function() {
            ...
            var new_cal = new Ext.FormPanel({
                ...
                items: [{
                        ...
                        items: [{
                            boxLabel: _('Create as New'),
                            name: 'rbMode',
                            inputValue: '1',
                            checked: true
                        }, {
                            boxLabel: _('Create as Copy'),
                            name: 'rbMode',
                            inputValue: '2'
                        }],
                        listeners: {
                            ...
                            if (btn == 'yes') {
                                ...
                                for (var x = 0; x < total_items; x++) {
                                    ...
                                    conn.request({
                                        ...
                                        params: {
                                            action: 'delete',
                                            id_cal: sm.selections.items[x].data.id
                                        },
                                        success: function(resp, opt) {
                                            grid.getStore().remove(sm.selections.items[0]);
                                        },
                                        failure: function(resp, opt) {
                                            Ext.Msg.alert(_('Error'), _('Could not delete the calendar'));
                                        }
            ...
            getRowClass: function(rec, index, p, store) {
                ...
                if (s) {
                    ...
                    p.body = String.format(
                        '<div style="padding: 0px 0px 0px 30px; color:#999">{0}</div>', s);
