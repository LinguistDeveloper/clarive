(function(){
    ...
    var button_del = new Ext.Button({
        icon:'/static/images/icons/delete-green.svg',
        cls: 'x-btn-text-icon',
        handler: function() {  }
    });
    ...
    var render_sem_actions = function(value,metadata,rec,rowIndex,colIndex,store) {
        ...
        var up = '<a href="#" onclick="javascript:Baseliner.sem_mod(\'add\', \''+ rec.data.key +'\', \''+rec.data.bl+'\' )">'
                + '<img src="/static/images/icons/arrow-up-green.svg"></img></a>';
        var down = slots > -1
            ? '<a href="#" onclick="javascript:Baseliner.sem_mod(\'del\', \''+ rec.data.key +'\', \''+rec.data.bl+'\')">'
                + '<img src="/static/images/icons/arrow-down-green.svg"></img></a>'
            : '';
        return up + down;
    };
    ...
    var render_actions = function(value,metadata,rec,rowIndex,colIndex,store) {
        ...
        var up = rowIndex == 0
            ? '<img src="/static/images/icons/arrow-up-green.svg" style="visibility: hidden"></img>'
    ...
    var render_status = function(value,metadata,rec,rowIndex,colIndex,store) {
        ...
        if( value == 'waiting' )
            ...
            img = '<img src="/static/images/icons/start-green.svg" alt="'+value+'"/>';
        else if( value == 'busy' )
            ...
            img = '<img src="/static/images/icons/stop-red.svg" alt="'+value+'"/>';
        else if( value == 'killed' )
            img = '<img src="/static/images/icons/error-triangle-red.svg" alt="'+value+'"/>';
        return img;
    };
    ...
    var grid_queue = new Ext.grid.GridPanel({
        ...
        bbar: [
            ...
            '<img class="icon_standar_size" src="/static/images/icons/start-green.svg" />', _('Granted'),
            '<img class="icon_standar_size" src="/static/images/icons/stop-red.svg" />', _('Cancelled'),
            '<img src="/static/images/icons/active.svg" />', _('Done'),
            '<img class="icon_standar_size" src="/static/images/icons/error-triangle-red.svg" />', _('Killed')
        ],
        view: gview,
        viewConfig: {
                scrollOffset: 2,
