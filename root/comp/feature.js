(function(){
   ...
   Baseliner.ProgressWindow = Ext.extend( Baseliner.Window, {
        ...
        initComponent: function(){
            ...
            self.list = new Ext.grid.EditorGridPanel({
                ...
                tbar: [
                    ...
                    { text:_('Diff Only'), icon:'/static/images/icons/good-green.svg', handler: function(){ self.checkout(false) } }
                ],
                cm: self.cm
            });
            self.add( self.list );
    ...
    var card = new Ext.Panel({
        ...
        tbar: [
            { text: _('Features'),
                icon: '/static/images/icons/features-purple.svg',
            ...
            { text: _('Restart Server'),
                icon: '/static/images/icons/restart-new.svg',
                handler: function(){
