...
% } else {
    var fpanel = new Ext.FormPanel({
        ...
        buttons: [
%if($c->stash->{create}){
            {  icon:'/static/images/icons/slot-green.svg', text: _('Create Active Slot'), handler: function(){ modify_window('A') } }
            ,{ icon:'/static/images/icons/slot-red.svg', text: _('Create Inactive Slot'), handler: function(){ modify_window('AD') } }
%} else {
...
%   if( $activa ) {
            ,{ icon:'/static/images/icons/stop-red.svg', text: _('Disable (No Job)'), handler: function(){  modify_window('C0')   } }
%   } else {
            ,{ icon:'/static/images/icons/start-green.svg', text: _('Activate Slot'), handler: function(){  modify_window('C1')   } }
%     }
% }
