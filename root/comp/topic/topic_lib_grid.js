...
Cla.topic_grid = function(params){
    ...
    var btn_yaml = {
        icon: '/static/images/icons/yaml-purple.svg',
        text: _('YAML'),
        handler: function() {
    ...
    */}.tmpl();
    ...
    var render_actions = function(value,metadata,rec,rowIndex,colIndex,store) {
        ...
        if (rec.data.numcomment) {
            swGo = true;
            actions_html.push("<span style='float: left; color: #808080'><img src='/static/images/icons/comment-blue.svg' class='x-topic-lib-inline-icon'/> ");
...
*/
    ...
    grid_topics.on( 'render', function(){
        ...
        if( !gt_view ) return;
        var dom = gt_view.el.dom;
        if( !dom ) return;
        var el = dom.childNodes[0].childNodes[1];
        if( !el ) return;
