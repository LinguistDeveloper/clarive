...
(function(){
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        columns: [
                ...
                { header: _('Natures'), width: 120, dataIndex: 'natures', sortable: false, renderer: render_nature }, // Eric; q7461x de momento not sortable xq no estÃ¡en BBDD
                { header: _('Subapplications'), width: 120, dataIndex: 'subapps', sortable: false, renderer: render_subapp }, // Eric; q7461x de momento not sortable  xq no estÃ¡ en BBDD
