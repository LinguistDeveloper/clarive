...
(function(params) {
    ...
    Baseliner.trap_check = function(mid){
        ...
        trap_win = new Baseliner.Window({
            ...
            items: [
                ...
                { flex:1, layout:'hbox', padding: 20,
                    items:[{ flex:1, xtype:'button', height: 50, text:'<b>'+_('Skip')+'</b>', icon:IC('job-trap-skip'),
    ...
    var htmlButton = new Ext.Toolbar.Button({ icon: IC('logo-html'),
        tooltip: _('HTML'),
...
% }
                            ...
                            if (res.success) {
                                ...
                                var msg = function(){/*
                                      ...
                                      <div class="container_24">
                                        <div class="grid_24">
                                        <h4>
                                            <img src="/static/images/icons/warning.svg" style="vertical-align:middle">
                                            [%= msg %]
                                        </h4>
                                        </div>
                                        <div class="clear"></div>
    ...
    var render_level = function(value,metadata,rec,rowIndex,colIndex,store,status) {
        ...
        if( icon!=undefined ) {
            var err_warn = '';
            err_warn += rec.data.has_warnings > 0 ? '<img src="/static/images/icons/job-log-warn.svg" />' : '';
            return div1
