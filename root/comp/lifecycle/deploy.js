(function(d) {
    ...
    Baseliner.confirm( _('Are you sure you want to deploy %1 in baseline %2', String.format("<b>{0}</b>", name), String.format("<b>{0}</b>",_(state_name)) ), function() { 
        Baseliner.ajaxEval( '/topic/newjob', { ns: ns, bl: bl, job_type: job_type }, function(res) {
            if( res.success ) {
