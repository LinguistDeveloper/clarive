 ...
 * 
 */
Ext.ux.form.SuperBoxSelectOrig = function(config) {
    Ext.ux.form.SuperBoxSelectOrig.superclass.constructor.call(this,config);
    this.addEvents(
        /**
...
Ext.ux.form.SuperBoxSelect = Ext.extend(Ext.ux.form.SuperBoxSelect,Ext.form.ComboBox,{
    ...
    initComponent:function() {
       Ext.apply(this, {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.initComponent.call(this);
    ...
    onRender:function(ct, position) {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.onRender.call(this, ct, position);
        this.hiddenName = h;
    ...
    initEvents : function() {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.initEvents.call(this);
    ...
    onFocus: function() {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.onFocus.call(this);
    },
    ...
    onBlur: function() {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.onBlur.call(this);
    },
    ...
    onResize : function(w, h, rw, rh) {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.onResize.call(this, w, h, rw, rh);
        this.autoSize();
    },
    onEnable: function(){
        Ext.ux.form.SuperBoxSelectOrig.superclass.onEnable.call(this);
    ...
    onDisable: function(){
        Ext.ux.form.SuperBoxSelectOrig.superclass.onDisable.call(this);
        this.items.each(function(item){
            item.disable();
        });
        if(this.renderFieldBtns){
    ...
    clearValue : function(supressRemoveEvent){
        Ext.ux.form.SuperBoxSelectOrig.superclass.clearValue.call(this);
    ...
    reset :  function(){
    	this.killItems();
        Ext.ux.form.SuperBoxSelectOrig.superclass.reset.call(this);
        this.addedRecords = [];
    ...
    // private
    initValue : function(){
        if(typeof(this.value)=='object' || Ext.isArray(this.value)){
            this.setValueEx(this.value);
            this.originalValue = this.getValue();
        }else{
            Ext.ux.form.SuperBoxSelectOrig.superclass.initValue.call(this);
        }
        if(this.mode === 'remote') {
    ...
    onDestroy : function() {
        ...
        Ext.ux.form.SuperBoxSelectOrig.superclass.onDestroy.call(this);
    },
    autoSize : function(){
        if(!this.rendered){
            return this;
...
Ext.reg('superboxselectorig', Ext.ux.form.SuperBoxSelectOrig);
/*
 * @private
 */
