Cla.Swarmgrupo7 = Ext.extend( Ext.Panel, {
    ...
    init : function(){
        ...
        { t:'9000', ev:'add', who:'alex', node: '#44350', parent:'Changeset' },
        { t:'10000', ev:'del', who:'alex', node: '#44350', parent:'Changeset' },
        { t:'11000', ev:'add', who:'fran', node: '#44351', parent:'Changeset' },        { t:'1000', ev:'add', who:'pedro', node: '#44343', parent:'Changeset' },
        { t:'2000', ev:'del', who:'pedro', node: '#44343', parent:'Changeset' },
        { t:'3000', ev:'add', who:'tot', node: '#44344', parent:'Changeset' },
        { t:'4000', ev:'del', who:'tot', node: '#44344', parent:'Changeset' },
        { t:'5000', ev:'add', who:'carlos', node: '#44345', parent:'Changeset' },
    ...
    start_inicial : function(){
        ...
        self.texto_nodos_iniciales.enter().append('text').attr("fill","url(#Color_texto_Raiz)").text(function(d) { return d.source.node;});   
    ...
    start : function(){
        ...
        self.node.enter().append("circle").attr("class", function(d) { return "node " + d.id; }).attr("r", 10).attr("fill","url(#Verde)")
                         .on('mouseover', function(d)
                         {
                            ...
                            self.node9.enter().append("text").attr("x", d.x-10).attr("y",d.y-10).text(self.array[d.id].t).transition().duration(3000).attr("x", d.x-10).attr("y", d.y+3).attr("fill","url(#Color_Texto_Nodos)").style("visibility", "visible");
                            self.node6.enter().append("text").attr("x", d.x-10).attr("y",d.y-10).text(self.array[d.id].ev).transition().duration(3000).attr("x", d.x-10).attr("y", d.y+16).attr("fill","url(#Color_Texto_Nodos)").style("visibility", "visible");
                            self.node7.enter().append("text").attr("x", d.x-10).attr("y",d.y-10).text(self.array[d.id].who).transition().duration(3000).attr("x", d.x-10).attr("y", d.y+29).attr("fill","url(#Color_Texto_Nodos)").style("visibility", "visible");
                            self.node8.enter().append("text").attr("x", d.x-10).attr("y",d.y-10).text(self.array[d.id].parent).transition().duration(3000).attr("x", d.x-10).attr("y", d.y+42).attr("fill","url(#Color_Texto_Nodos)").style("visibility", "visible");
    ...
    userstart : function(){
        ...
        self.link2 = self.link2.data(self.force.links(), function(d) { return d.source.id + "-" + d.target.id; });
        self.link2.enter().insert("line", ".node").attr("stroke","url(#Amarillo)").attr("stroke-opacity",0.6).attr("class", "link");       
        self.link2.exit().remove();
