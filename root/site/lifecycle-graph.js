...
//General Button
var btn_general = new Ext.Button({ text: _('Plain'), icon: IC('life-cycle-general'), pressed: true, allowDepress: false, toggleGroup: 'process-'+iid, handler: function(){
    menu_general.show();
    menu_role.hide();
...
//Role Button
var btn_role = new Ext.Button({ text: _('Role'), icon: IC('life-cycle-rol'), pressed: false, allowDepress: false, toggleGroup: 'process-'+iid, handler: function(){
    menu_general.hide();
    menu_role.show();
...
var menu_general = new Ext.Button({
    text: _('Options'), icon: IC('life-cycle-general'), menu:{
        items: [
...
var menu_role = new Ext.Button({
    text: _('Options'), icon: IC('life-cycle-rol'), hidden: true, menu:{
      items: [
