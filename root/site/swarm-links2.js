Cla.Swarm = Ext.extend( Ext.Panel, {
    ...
    start_anim : function(){
        ...
        setTimeout(function(){ self.anim() },4000);
    },
    stop_anim : function(){
    ...
    add_user_node : function(a,d){
        var self = this;
        self.nodes.push(d);
        self.links.push({source: d, target: self.nodes[3]});
    ...
    add2 : function(){
        ...
        self.add_group_node( self.nodes[2],{id: "#d"+Math.random(), t: "iniciales", ev: "iniciales", who: "iniciales", node: "iniciales", 
            parent: 'xxx', color: "green", posicionx: 0, posiciony: 0} ); 


        self.add_user_node( self.nodes[5],{id: "#d"+Math.random(), t: "iniciales", ev: "iniciales", who: "iniciales", node: "usuario", 
            parent: 'xxx', color: "green", posicionx: 0, posiciony: 0} ); 
    ...
    mover : function(){
        ...
        self.add_user_mover( self.nodes[0],self.nodes[2],self.nodes[3] ); 
        setTimeout(function(){ self.mover() },2000);
        self.add_user_mover( self.nodes[0],self.nodes[1],self.nodes[2] );
        setTimeout(function(){ self.mover() },2000); 
        self.add_user_mover( self.nodes[0],self.nodes[0],self.nodes[1] ); 
