...
Baseliner.escapeHtmlEntities = function(text) {
    return text.replace(/[\u00A0-\u2666<>\& \t\s]/g, function(c) {
        return '&' +
            (Baseliner.escapeHtmlEntities.entityTable[c.charCodeAt(0)] || '#' + c.charCodeAt(0)) + ';';
    });
};

Baseliner.escapeHtmlEntities.entityTable = {
    32: 'nbsp',
    34: 'quot',
    38: 'amp',
    39: 'apos',
