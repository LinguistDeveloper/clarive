              ...
              while (i < res.data.length){
                  ...
                  if (objectNode.length==0){
                    if(res.data[i].status_type == "I"){
                      ...
                      objectNode.push({ "key" : res.data[i].role+res.data[i].status_from, "text": res.data[i].status_from, "color"  : res.data[i].status_color, "textColor": invertir_Color(res.data[i].status_color),  "figure"  : "RoundedRectangle", group: res.data[i].role});
                    }
                  }else{
                    var j=0;
                    var equal = 1;
                  ...
                  while(k < res.data[i].statuses_to.length){
                      if (objectNode.length==0){
                        if(res.data[i].statuses_to_type[k] == 'F'){
                          ...
                          objectNode.push({ "key" : res.data[i].role+res.data[i].statuses_to[k], "text": res.data[i].statuses_to[k], "color"  : res.data[i].status_color, "textColor": invertir_Color(res.data[i].status_color), "figure"  : "Ellipse", group: res.data[i].role});
                        }
                      }else{
                        var j=0;
                        var equal = 1;
