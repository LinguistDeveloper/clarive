Cla.Swarmgrupo = Ext.extend( Ext.Panel, {
    ...
    userstart : function(){
        ...
        self.node3 = self.node3.data(self.force.nodes(), function(d) { return d.id;});
        self.node3.enter().append("text").attr("x", randomValuex-150).attr("y",randomValuey).text(self.array[self.i].who).attr("fill","#00CCFF").transition().duration(6000).attr("x",randomValuex).ease("elastic").remove();
        self.node3.exit().remove();
