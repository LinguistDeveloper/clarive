...
Baseliner.Kanban = Ext.extend( Ext.ux.Portal, {
    ...
    is_fullscreen : false,
    is_tab : false,
    background: "#555 url('/static/images/background/CORK_1.jpg')",
    //background: "#535051",
    title: _('Kanban'),
    header: false,
    ...
    changeStatusTopic: function(portletObj, newStatus, oldStatus){
        var self = this;
        self.el.mask('');
        Baseliner.ajaxEval( '/topic/change_status',{ mid: portletObj.mid, new_status: newStatus, old_status: oldStatus },
            function(res) {
            ...
            function(res) {
                ...
                if( Ext.isFunction(this.failure) ) this.failure(res);
                self.el.unmask();
            }
        );
    },
