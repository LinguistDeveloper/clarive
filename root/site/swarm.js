Cla.Swarm = Ext.extend( Ext.Panel, {
    ...
    redraw: function(){
        var self = this;
        // TODO ajax_json data here?
        self.init();
        self.update2( self.data );
    },
    init : function(){
        var self = this;

        var id = self.body.id; 
        var height = self.height; // || self.body.getHeight();
        var width = self.width; // || self.body.getWidth();
        //self.width = width;
        //self.height = height;
        var selector = '#' + id; 
    ...
    update2 : function(json) {
        var self = this;
        if (json) this.json = json;

        this.json.fixed = true;
        this.json.x = this.width / 2;
        this.json.y = this.height / 2;
    ...
    mouseover : function(d) {
        var self = this;
        self.text.attr('transform', 'translate(' + d.x + ',' + (d.y - 5 - (d.children ? 3.5 : Math.sqrt(d.size) / 2)) + ')')
