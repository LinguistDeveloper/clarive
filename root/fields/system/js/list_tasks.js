...
(function(params){
    ...
    var show_status = function(value,metadata,rec,rowIndex,colIndex,store) {
        ...
        if(!value){
            ...
            var img = value=="OK" ? "drop-ok.svg" : value=="KO" ? "close.svg" : "help.svg";
    ...
    var time_tpl = new Ext.XTemplate(
        ...
        '<table><tr><td><img src="/static/images/icons/{[ values.status=="OK" ? "drop-ok.svg" : values.status=="KO" ? "close.svg" : "help.svg" ]}"/></td>',
