...
(function(params) {
    ...
    if (meta.display_mode == 'description') {
        tpl = new Ext.XTemplate(
          ...
          + '<span id="boot" style="background: transparent"><div style="float:left; margin-right: 5px; margin-top: -1px"><img src="{icon}" width="16" /></div><strong>{name} </strong></span>'
        ...
        tpl = new Ext.XTemplate(
            '<tpl for="."><div class="x-combo-list-item">'
          + '<span id="boot" style="background: transparent"><div style="float:left; margin-right: 5px; margin-top: -1px"><img src="{icon}" width="16" /></div><strong>{name}</strong> <span class="x-combo-name-list-description">{values.bl} </span></span>'
          + '</div></tpl>'
        );
    } else if (meta.display_mode == 'moniker') {
        tpl = new Ext.XTemplate(
            '<tpl for="."><div class="x-combo-list-item">'
          + '<span id="boot" style="background: transparent"><div style="float:left; margin-right: 5px; margin-top: -1px"><img src="{icon}" width="16" /></div><strong>{name}</strong> <span class="x-combo-name-list-description">{values.moniker} </span></span>'
          + '</div></tpl>'
        );
    } else {
        tpl = new Ext.XTemplate(
