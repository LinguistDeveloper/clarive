...
(function(params){ 
    ...
    Cla.ajax_json('/dashboard/list_topics', { project_id: project_id, limit:limit, assigned_to: assigned_to, condition: condition, not_in_status: not_in_status, categories: categories, statuses: statuses, _ignore_conn_errors: true  }, function(res){
