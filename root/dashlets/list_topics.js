...
(function(params){ 
    ...
    Cla.ajax_json('/dashboard/list_topics', { condition: condition, not_in_status: not_in_status, categories: categories, statuses: statuses }, function(res){
