(function(params){ 
    ...
    var days_before_format_date = params.data.days_before_format_date || 0;
    ...
    var format = '%Y/%m/%d';
      ...
      Cla.ajax_json('/dashboard/topics_period_burndown', {
            ...
            days_before_format_date: days_before_format_date,
            days_after_format_date: days_after_format_date,
            date_type: date_type,
            date: date,
