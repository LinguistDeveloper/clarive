...
(function(params){ 
    ...
    Cla.ajax_json('/dashboard/topic_activity', { assigned_to: assigned_to, condition: condition, not_in_status: not_in_status, categories: categories, statuses: statuses, _ignore_conn_errors: true  }, function(res){
