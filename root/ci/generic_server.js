(function(params){
    return [
        ...
        new Baseliner.CBox({ fieldLabel: _('Connect by FTP'), name: 'connect_ftp', checked: params.rec.connect_ftp, default_value: false }),
        new Baseliner.CBox({ fieldLabel: _('Connect by Worker'), name: 'connect_worker', checked: params.rec.connect_worker, default_value: false }),
        new Baseliner.CBox({ fieldLabel: _('Connect by Balix'), name: 'connect_balix', checked: params.rec.connect_balix, default_value: false }),
